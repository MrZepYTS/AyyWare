...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Menu, "Tahoma", 12, 400, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Text, "Tahoma", 30, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "Verdana", 12, 400, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "Tahoma", 11, 700, 0, 0, FONTFLAG_NONE);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuText, "Tahoma", 16, 500, 0, 0, FONTFLAG_ANTIALIAS);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Clock, "Tahoma", 22, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::LBY, "Verdana", 20, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
