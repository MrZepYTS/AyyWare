...
const char* clantaganimation[162] =
{
	"Greatness",
	"Greatnes",
	"Greatne",
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	{
		if (Menu::Window.VisualsTab.AAIndicators.GetState())
		{
			int W, H, cW, cH;
			...
			{
				if (Menu::Window.RageBotTab.ManualAAEnable.GetState())
				{
					if (GetKeyState(Menu::Window.RageBotTab.ManualAASwitch.GetKey()))
					{
